 ...
 */
class Categorie extends \Smart\AnnonceBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Categorie' . "\0" . 'nom', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Categorie' . "\0" . 'etat', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Categorie' . "\0" . 'token');
        }
