...
namespace Proxies\__CG__\Smart\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Smart\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Smart\\UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'Smart\\UserBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'Smart\\UserBundle\\Entity\\User' . "\0" . 'dateinscription', '' . "\0" . 'Smart\\UserBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'Smart\\UserBundle\\Entity\\User' . "\0" . 'mobile', '' . "\0" . 'Smart\\UserBundle\\Entity\\User' . "\0" . 'image', '' . "\0" . 'Smart\\UserBundle\\Entity\\User' . "\0" . 'governorat', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setGovernorat(\Smart\AnnonceBundle\Entity\Governorat $governorat)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGovernorat', array($governorat));

        return parent::setGovernorat($governorat);
    }
    ...
    public function getGovernorat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGovernorat', array());

        return parent::getGovernorat();
    }
