...
namespace Proxies\__CG__\Smart\AnnonceBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \Smart\AnnonceBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'Smart\\AnnonceBundle\\Entity\\Image' . "\0" . 'tempFilename');
        }
